...
def train_lite_act_two_sp_level_couple_transp_rigsurdel_topacity(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    ...
    **kwargs,
    ...
    if level == 0:
        ...
        level_1_point_opacity = gm.get_level_1_opacity(viewpoint_camera.time_idx)
        ...
        level_1_opacity = level_1_point_opacity * level_1_time_coefficient

        level_1_scales = gm.get_level_1_scaling
        level_1_scales = level_1_scales * level_1_time_coefficient

        level_1_tforpoly = level_1_trbf_distance_offset
...
def test_lite_act_two_sp_level_couple_transp_rigsurdel_topacity_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
    ...
    **kwargs,
    ...
    level_0_delta_rig_sur_azimuth_dummy = torch.zeros(
        (n_level_0_points, 1), dtype=level_0_means3D.dtype, device="cuda"
    )
    ...
    if level == 0:
        ...
        level_1_trbf_scale = torch.ones((n_level_1_points, 1), dtype=level_1_trbf_center.dtype, device="cuda")
        ...
        if transp_level_0:
            ...
            delta_rig_sur_azimuth = torch.cat(
                (level_0_delta_rig_sur_azimuth_dummy, level_1_delta_rig_sur_azimuth), dim=0
            )
