...
class GaussianModel:
    ...
    def densify_pruneclone_im(self, max_grad, min_opacity, extent, max_screen_size, splitN=1):
    ...
    def densify_prune_clone_imgeneral(self, max_grad, min_opacity, extent, max_screen_size, splitN=1):
        grads = self.xyz_gradient_accum / self.denom
        grads[grads.isnan()] = 0.0
