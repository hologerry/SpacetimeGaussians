...
def train_lite_act_two_sp_level_couple_transp_zerodel_tcolor(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    ...
    **kwargs,
    ...
    if level == 1:
        ...
        output_dict["level_1_colors_precomp"] = level_1_colors_precomp

    return output_dict


def test_lite_act_two_sp_level_couple_transp_zerodel_tcolor_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
...
def sim_lite_act_two_sp_level_couple_transp_zerodel_tcolor_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
    ...
    **kwargs,
    ...
    if level == 0:
        ...
        level_1_cur_means3D = gm._sim_cur_means3D
        level_1_velocities3D = gm._sim_cur_velocity_field
