...
def main():
    ...
    # Exhaustive matcher
    parser.add_argument(
        "--ExhaustiveMatching.block_size", type=int, dest="exhaustiveMatcher_ExhaustiveMatchingBlockSize"
    )

    # Mapper
    parser.add_argument(
        "--Mapper.ba_local_max_num_iterations", type=int, dest="mapper_MapperDotbaLocalMaxNumIterations"
    )
    parser.add_argument(
        "--Mapper.ba_global_max_num_iterations", type=int, dest="mapper_MapperDotbaGlobalMaxNumIterations"
    )
    ...
    with open(
        os.path.join(os.path.abspath(os.path.dirname(__file__)), "ColmapQualityParameters.json"), "r"
    ...
    # Get process steps
    with open(
        os.path.join(os.path.abspath(os.path.dirname(__file__)), "SelectiveColmapProcessSteps.json"), "r"
    ) as processStepsFile:
