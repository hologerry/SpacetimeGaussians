...
def train_lite_act_two_sp_level_couple_transp_zerodel(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
...
def test_lite_act_two_sp_level_couple_transp_zerodel_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
...
def sim_lite_act_two_sp_level_couple_transp_zerodel_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
