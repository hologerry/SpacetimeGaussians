...
for im in list_images:
    ...
    shutil.copy(os.path.join(path_data, im.split(" ", 1)[0]), os.path.join(path_dest, "images", im.split(" ", 1)[0]))
...
shutil.copy(os.path.join(path_data, "list_images.txt"), os.path.join(path_dest, "images", "list_images.txt"))

shutil.copy(os.path.join(path_data, "bundle.out"), os.path.join(path_dest, "cameras", "bundle.out"))

shutil.copy(os.path.join(path_data, "pmvs/models/pmvs_recon.ply"), os.path.join(path_dest, "meshes/recon.ply"))
