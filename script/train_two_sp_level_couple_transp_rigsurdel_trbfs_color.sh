...
python train_two_sp_level.py \
    ...
    --model_path /data/Dynamics/SpacetimeGaussiansLog/gaussian_fluid_scalar_real/two_sp_level_couple_transp_rigsurdel_trbfs1_L1_default_L2_default_ras5.0_const-ra-az-po_no-prune \
    --loader hyfluid
exit
}
