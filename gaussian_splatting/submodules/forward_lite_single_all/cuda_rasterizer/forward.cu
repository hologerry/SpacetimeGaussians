...
__global__ void prepreprocessCUDA(
    ...
    orig_pointsdummy[3 * idx] = orig_points[3 * idx] + trbf_distance * motion[3 * idx]; // + trbf_distance2 * motion[9 * idx + 3]; // + trbf_distance3 * motion[9 * idx + 6];
    orig_pointsdummy[3 * idx + 1] = orig_points[3 * idx + 1] + trbf_distance * motion[3 * idx + 1]; // + trbf_distance2 * motion[9 * idx + 4]; // + trbf_distance3 * motion[9 * idx + 7];
    orig_pointsdummy[3 * idx + 2] = orig_points[3 * idx + 2] + trbf_distance * motion[3 * idx + 2]; // + trbf_distance2 * motion[9 * idx + 5]; // + trbf_distance3 * motion[9 * idx + 8];
