	...
	float* rotationsdummy)
{
	...
	float r0 = rotations[4 * idx] + trbf_distance * rotationst[4 * idx];
	float r1 = rotations[4 * idx+1] + trbf_distance * rotationst[4 * idx+1];
	float r2 = rotations[4 * idx+2] + trbf_distance * rotationst[4 * idx+2];
	float r3 = rotations[4 * idx+3] + trbf_distance * rotationst[4 * idx+3];
