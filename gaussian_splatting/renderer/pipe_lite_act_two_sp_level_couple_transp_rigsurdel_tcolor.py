...
def train_lite_act_two_sp_level_couple_transp_rigsurdel_tcolor(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    ...
    **kwargs,
    ...
    if level == 0:
        ...
        level_1_colors_precomp = gm.get_level_1_features(viewpoint_camera.time_idx)
...
def test_lite_act_two_sp_level_couple_transp_rigsurdel_tcolor_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
