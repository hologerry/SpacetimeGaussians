...
python test.py \
    ...
    --model_path /data/Dynamics/SpacetimeGaussiansLog/synthetic_particle/simple_1_point_grey_color_scale-5_rotation_opacity_act_trbfcInit0_small_N1_simple_trajectory_no_clone_split \
