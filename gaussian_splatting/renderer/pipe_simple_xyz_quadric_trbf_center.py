...
from gaussian_splatting.gaussian.gm_simple_xyz_quadric_trbf_center import GaussianModel


def train_pipe_lite_xyz_quadric_trbf_center(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
...
def test_pipe_lite_xyz_quadric_trbf_center_vis(
    viewpoint_camera,
    gm: GaussianModel,
    pipe,
    bg_color: torch.Tensor,
