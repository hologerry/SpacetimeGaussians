...
python test_two_sp_level.py \
    ...
    --model_path /data/Dynamics/SpacetimeGaussiansLog/gaussian_fluid_scalar_real/two_sp_level_couple_transp_zerodel_trbfs2_L1_default_L2_default_prunedarkcolor005 \
