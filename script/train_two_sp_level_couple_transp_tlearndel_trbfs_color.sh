...
python train_two_sp_level.py \
    ...
    --model_path /data/Dynamics/SpacetimeGaussiansLog/gaussian_fluid_scalar_real/two_sp_level_couple_transp_tlearndel_trbfs1_color_L1_default_L2_default_lrdeltaxyzsmooth1e2 \
    --loader hyfluid
exit
}
